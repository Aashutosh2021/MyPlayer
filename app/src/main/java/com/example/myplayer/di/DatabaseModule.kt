...
object DatabaseModule {
    ...
    @Provides @Singleton fun provideCachedRecommendationDao(db: AppDatabase): com.example.myplayer.data.local.dao.CachedRecommendationDao = db.cachedRecommendationDao()
}
